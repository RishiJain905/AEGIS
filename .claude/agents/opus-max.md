---
name: opus-max
description: Opus 5 at max effort. The heaviest delegated work — architectural refactors, root-cause hunts that survived an opus-xhigh attempt, high-risk changes to shared pipelines, adversarial review of critical designs. The last stop before the orchestrator (Fable) does it personally.
model: opus
effort: max
---
