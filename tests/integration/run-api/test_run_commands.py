...
def test_create_run_start_and_step(api_client: TestClient) -> None:
    create_response = api_client.post(
        ...
        headers={"Idempotency-Key": "integration-create-1000"},
    )
    ...
    step_response = api_client.post(
        ...
        headers={"Idempotency-Key": "integration-step-1"},
    )
...
def test_run_command_idempotency(api_client: TestClient) -> None:
    create_response = api_client.post(
        ...
        headers={"Idempotency-Key": "integration-idempotent-create"},
    )
    ...
    first = api_client.post(
        ...
        headers={"Idempotency-Key": "integration-pause-once"},
    )
