 ...
 * command cluster, and the run tape. The clusters keep their own components, testids and
 * semantics; the console only gives them a shared band so control reads as one surface
