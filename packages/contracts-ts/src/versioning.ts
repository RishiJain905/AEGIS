export const WORKSPACE_VERSION = '1.0.0' as const;
...
export const INVESTIGATION_DETAIL_SCHEMA_VERSION = 4;
...
export const STALE_PROPOSAL_ERROR_SCHEMA_VERSION = 1;
export const PROPOSAL_MODIFICATION_SCHEMA_VERSION = 1;
export const FINAL_POLICY_CHECK_SCHEMA_VERSION = 1;
export const AUTHORIZED_SIMULATION_COMMAND_SCHEMA_VERSION = 1;
export const EXECUTION_RESULT_SCHEMA_VERSION = 1;
export const APPROVE_PROPOSAL_REQUEST_SCHEMA_VERSION = 1;
export const REJECT_PROPOSAL_REQUEST_SCHEMA_VERSION = 1;
export const MODIFY_PROPOSAL_REQUEST_SCHEMA_VERSION = 1;
export const CANCEL_PROPOSAL_REQUEST_SCHEMA_VERSION = 1;
...
export const REPLAY_CURSOR_SCHEMA_VERSION = 1;
export const REPLAY_CURSOR_RANGE_SCHEMA_VERSION = 1;
export const REPLAY_PROVENANCE_SCHEMA_VERSION = 1;
export const REPLAY_STATE_SCHEMA_VERSION = 1;
export const REPLAY_SNAPSHOT_SCHEMA_VERSION = 1;
...
export const SUPPORTED_SCHEMA_VERSIONS: Readonly<Record<string, readonly number[]>> = {
  ...
  investigation_detail: [1, 2, 3, INVESTIGATION_DETAIL_SCHEMA_VERSION],
  stale_proposal_error: [STALE_PROPOSAL_ERROR_SCHEMA_VERSION],
  proposal_modification: [PROPOSAL_MODIFICATION_SCHEMA_VERSION],
  final_policy_check: [FINAL_POLICY_CHECK_SCHEMA_VERSION],
  authorized_simulation_command: [AUTHORIZED_SIMULATION_COMMAND_SCHEMA_VERSION],
  execution_result: [EXECUTION_RESULT_SCHEMA_VERSION],
  approve_proposal_request: [APPROVE_PROPOSAL_REQUEST_SCHEMA_VERSION],
  reject_proposal_request: [REJECT_PROPOSAL_REQUEST_SCHEMA_VERSION],
  modify_proposal_request: [MODIFY_PROPOSAL_REQUEST_SCHEMA_VERSION],
  cancel_proposal_request: [CANCEL_PROPOSAL_REQUEST_SCHEMA_VERSION],
  ...
  replay_cursor: [REPLAY_CURSOR_SCHEMA_VERSION],
  replay_cursor_range: [REPLAY_CURSOR_RANGE_SCHEMA_VERSION],
  replay_provenance: [REPLAY_PROVENANCE_SCHEMA_VERSION],
  replay_state: [REPLAY_STATE_SCHEMA_VERSION],
  replay_snapshot: [REPLAY_SNAPSHOT_SCHEMA_VERSION],
