...
Use sequential files such as `0001-title.md`.
...
Latest relevant ADR for Phase 29: [`0030-scoring-and-after-action.md`](0030-scoring-and-after-action.md).

Phase 28 cinematic incident replay: [`0029-cinematic-incident-replay.md`](0029-cinematic-incident-replay.md).
...
Phase 25 reconstruction authority remains: [`0026-snapshot-and-replay-engine.md`](0026-snapshot-and-replay-engine.md).
